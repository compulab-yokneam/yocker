...
|ucm-imx95|||||||**22.04<br>(```1.0```)<br>**
|ucm-imx93l|||||22.04<br>(```below 3.0```)||**22.04<br>(```3.0```)<br>**
|ucm-imx93||||20.04<br>(```below 2.0```)|22.04<br>(```2.0```)||**22.04<br>(```3.0```)<br>**
|mcm-imx93||||||22.04<br>(```1.0```)<br>|**22.04<br>(```2.0```)<br>**|
...
|ucm-imx8m-mini||||20.04<br>(```3.2.2```)<br>|||**22.04<br>(```4.0```)<br>**|
|iot-gate-imx8||||20.04<br>(```3.2.1```)<br>|||**22.04<br>(```4.0```)<br>**|
